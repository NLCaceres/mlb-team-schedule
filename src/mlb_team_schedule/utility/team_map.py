...
#TODO: BUT maybe better to let KeyError immediately be raised in case user misspells team?
# SINCE not setting team can default to LA Dodgers with guaranteed correct spelling
def getTeamIdFromName(name: str):
    return TEAM_TO_ID_MAP.get(name.lower())


# get() the Flask Config's team full name env var that defaults to 'Los Angeles Dodgers'
