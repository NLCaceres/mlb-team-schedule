...
def test_getTeamIdFromName():
    ...
    #* WHEN case is mixed, THEN we still get the correct team as long as spelling is correct
    #* NL Central
...
def test_getTeamID(app):
     #? Monkeypatching works BUT turns out app.config is just a simple subclass of Python's dictionary
